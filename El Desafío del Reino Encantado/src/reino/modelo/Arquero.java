...
public class Arquero extends Heroe{
    ...
    public int usarHabilidadEspecialAtaque(Personaje defensor, int cantGolpes) {
		// TODO: Arreglar que acierte correctamente el golpe cuando entre al if
        Random random = new Random();
        int numeroAleatorio = random.nextInt(100); // Generar un número aleatorio entre 0 y 99
		if(numeroAleatorio < punteria){ // Si entra aca acierta el golpe
			return 9999;  // Setea un número alto para para asegurar acertar el golpe
		}
        return 0;
    }
